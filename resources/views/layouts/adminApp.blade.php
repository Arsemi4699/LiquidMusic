...
<head>
    ...
    @vite(['resources/sass/studioApp.scss'])
    @livewireStyles
</head>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" {{ route('admin.dashboard') }} ">
                ...
                <span class="ms-1 font-weight-bold">Liquid Music</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link @yield('DashActive')" href="{{ route('admin.dashboard') }}">
                        <div
                ...
                <li class="nav-item">
                    <a class="nav-link @yield('ReportActive')" href="{{ route('admin.report') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">گزارش آهنگ ها</span>
                    </a>
                </li>
                @if (Auth::guard('admin')->user()->role == 'super')
                    <li class="nav-item">
                        <a class="nav-link @yield('AdminsActive')" href="{{ route('admin.adminManager') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <span class="nav-link-text ms-1">مدیریت ادمین ها</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  @yield('PlansActive')" href="{{ route('admin.plansManager') }}">
                          ...
                          <span class="nav-link-text ms-1">مدیریت اشتراک ها</span>
                        </a>
                      </li>
                @endif
                @if (Auth::guard('admin')->user()->role == 'master' || Auth::guard('admin')->user()->role == 'super')
                    <li class="nav-item">
                        <a class="nav-link @yield('BankActive')" href="{{ route('admin.financial') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <span class="nav-link-text ms-1">امور مالی</span>
                        </a>
                    </li>
                @endif
            </ul>
            ...
            <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-0" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex ms-3 align-items-center">
                            <a href="javascript:;"
                                class="nav-link text-body font-weight-bold px-0 d-flex align-items-center">
                                <span class="d-sm-inline d-none mx-1">{{ Auth::guard('admin')->user()->name }}</span>
                                {{-- <img style="width: 45px; height: 45px; border-radius: 100%;"
                                    src="{{ asset('storage/images/avatars/' . Auth::user()->file_path_profile_img) }}"
                                    alt="liquidMusic"> --}}
                            </a>
                        </li>
                        <li class="nav-item d-flex ms-3 align-items-center">
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="exit__btn" type="submit">
                                    <i class="bi bi-box-arrow-left text__color__primary fs-3 inline-block"></i>
                                </button>
                            </form>
                        </li>
                    </ul>
