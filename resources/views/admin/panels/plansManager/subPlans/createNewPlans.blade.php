    ...
    <div>
        <div class="row m-4" dir="rtl">
            <div class="col-md-6 offset-md-3">
                <h4 class="mb-3">افزودن اشتراک: </h4>
                <form action="{{ route('admin.createPlans') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="duration" type="number" class="form-control" id="duration" value="{{ old('duration') }}" min="0" placeholder="مدت به روز">
                        @error('duration')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
